...
var _jsxFileName = "/Users/hikouki/.ghq/github.com/hikouki/gatsby-background-image/packages/gatsby-background-image-es5/src/index.js";
...
function (_React$Component) {
  ...
  function BackgroundImage(props) {
    ...
    _this.handleRef = (0, _bind.default)(_context2 = _this.handleRef).call(_context2, (0, _assertThisInitialized2.default)(_this)); // Create reference(s) to an Image loaded via picture element in background.

    _this.imageRef = (0, _ImageUtils.createPictureRef)((0, _assign.default)({}, props, {
      isVisible: isVisible
  ...
  _proto.componentDidUpdate = function componentDidUpdate(prevProps) {
    ...
    if ((0, _ImageUtils.imagePropsChanged)(this.props, prevProps)) {
      ...
      this.setState({
        ...
        _this2.imageRef = (0, _ImageUtils.createPictureRef)((0, _assign.default)({}, _this2.props, {
  ...
  _proto.render = function render() {
    ...
    if (fluid) {
      image = fluid;
      noScriptImageData = (0, _isArray.default)(fluid) ? fluid[0] : fluid;
    } else if (fixed) {
      image = fixed;
      ...
      noScriptImageData = (0, _isArray.default)(fixed) ? fixed[0] : fixed;
    } else {
      return null;
    ...
    var pseudoStyles = (0, _StyleUtils.createPseudoStyles)((0, _assign.default)({
      classId: classId,
    ...
    return _react.default.createElement(Tag, (0, _extends2.default)({
      ...
      style: (0, _assign.default)({}, divStyle, {}, this.backgroundStyles),
      ref: this.handleRef,
      key: componentKey
    }, remainingProps, {
      __source: {
